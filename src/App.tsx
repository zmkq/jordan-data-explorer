    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-200 flex flex-col items-center justify-center p-6 font-sans text-slate-900">
      ...
      <div className="max-w-3xl text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button className="w-full sm:w-auto px-8 py-3 rounded-lg bg-blue-600 text-white font-semibold shadow-lg shadow-blue-600/30 hover:bg-blue-700 transition-all active:scale-95">
            Explore Datasets
          </button>
